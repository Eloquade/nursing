...
const Footer = () => {
  ...
  return (
    <footer class="footer-1 bg-top py-8 sm:py-12">
      <div class="container mx-auto px-4 text-white">
        <div class="sm:flex sm:flex-wrap sm:-mx-4 md:py-4">
          <div class="px-4 sm:w-1/2 md:w-1/4 xl:w-1/6">
            <h5 class="text-xl font-bold mb-6">Features</h5>
            <ul class="list-none footer-links text-base">
              <li class="mb-2">
                <a
                  href="#"
                  class="border-b border-solid border-transparent hover:border-white-800 hover:text-white-800"
                >
